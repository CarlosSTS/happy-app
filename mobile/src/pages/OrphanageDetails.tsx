...
export default function OrphanageDetails() {
  ...
  const message = `olá ${orphanage.name} estou estrando em contato pois gostaria de saber mais instruções sobre o orfanato `
...
Linking.openURL(`whatsapp://send?phone=${orphanage?.phone}&text=${message}`)
  }
